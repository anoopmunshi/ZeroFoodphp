...
$countData = file_get_contents("http://".$host_url.":".$port."/api/food-centers/count");
...
<script type="text/javascript">
	$(document).on('keypress',function(e) {
		if(e.which == 13) {
			setTimeout(function(){ getSearch(); }, 300);
			return false;
		}
	});
	function getSearch(){
...
<div class="container">
	...
	<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDoMXXWxR6c9tQEh97X7qWFiYLOJq2y_3E&sensor=false&libraries=places"></script>
	<script type="text/javascript">
